...
interface IList<E> extends Iterable<E> {
	...
	void add(int index, E element) throws NoSuchElementException; // not
																	// implemented
	...
	E set(int index, E element) throws NoSuchElementException; // not
																// implemented
	...
	ListIterator<E> listIterator() throws UnsupportedOperationException; // for
																			// ListIterator

	E remove(int index) throws NoSuchElementException; // remove element from
														// position index
